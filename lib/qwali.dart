          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: ElevatedButton(
                    onPressed: () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (context)=>ThirdParty()));
                    },
    ...
    return  Container(
      ...
      decoration: const BoxDecoration(
          ...
          image: DecorationImage(
              image: AssetImage('img/qwali.webp'), fit: BoxFit.fill)),
    );
  }
  @override
  Widget build(BuildContext context) {
